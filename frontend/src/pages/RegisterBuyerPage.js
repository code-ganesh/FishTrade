// client/src/pages/RegisterBuyerPage.js
...
const RegisterBuyerPage = () => {
  ...
  const handleSubmit = async (userData) => {
    ...
    try {
      ...
      navigate('/dashboard/buyer'); // Redirect buyer to their dashboard
    } catch (err) {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-sky-blue to-sea-blue flex flex-col items-center justify-center overflow-hidden py-12">
      ...
      <div className="relative z-20">
        <BuyerRegisterForm onSubmit={handleSubmit} isLoading={isLoading} error={error} />
      </div>
    </div>
  );
};
